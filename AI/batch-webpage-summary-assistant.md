...
description = "Batch Webpage Summary Assistant 批次網頁摘要助手"
...
[extra]
banner = "https://img.maki0419.com/blog/ai-batch-webpage-summary-assistant/preview.png"
+++
...
正如其名，這個助手的主要功能是批次處理大量網頁，為每個網頁生成精簡而全面的摘要。它是我在設計[「摘要索引與全文參考方法」](https://blog.maki0419.com/2024/08/say-goodbye-to-ai-hallucinations-a-simple-method-to-Improve-the-accuracy-of-your-rag-system.html)時製作的輔助工具。
...
2. 設定物件陣列輸出如圖。
3. 使用 browse plugin 下載網頁內容。  
記得在上方切換至 Batch processing，並在 url 選中 browse-url
4. 在 LLM 節點中使用取得的完整網頁內容。  
LLM 的 prompt 請參考文章[告別 AI 幻覺：一個簡單方法提升你的 RAG 系統精準度](/2024/08/say-goodbye-to-ai-hallucinations-a-simple-method-to-Improve-the-accuracy-of-your-rag-system.html)
