...
[extra]
banner = "https://img.maki0419.com/blog/preview/whisperx.png"
+++
## 前言

[![](https://img.maki0419.com/blog/preview/whisperx.png)](https://img.maki0419.com/blog/preview/whisperx.png)
...
轉錄中文和日文時一定要加上參數 `--chunk_size`，5\~10 都不錯，如果斷句很怪的話在此範圍調調看。具體用法可以查看[這支我提交的 PR](https://github.com/m-bain/whisperX/pull/445)  
(預設值是驚人的 30)
...
iscn://likecoin-chain/i6XMdfLq3nGAU\_inrEqxpsDKOlCbHyUkwJZLl-U1aXk