...
updated = "2025-01-27T02:46:31.803Z"
...
iscn = "iscn://likecoin-chain/YBFzpFI86kKaDC4aYgU5t9hd1nLmqDvHVhS5h5W-VaA/1"
  ...
  [extra.preview]
  withAI = true
  url = "https://civitai.com/images/49113018"
  description = "i2i with Flux1.D from the original image created by ChatGPT DALL-E"
+++
## 嗶嗶 🤖 機油好難喝
...
網頁提示詞注入技術直接威脅了 AI 搜尋服務提供的資訊準確性。{{cr(body="隨著使用者越來越依賴 AI 來總結和解釋網頁內容，他們可能會無意中獲取錯誤或有偏差的資訊。")}}
...
網頁提示詞注入也使 AI 模型面臨嚴峻挑戰。{{cr(body="當大量網頁包含隱藏提示詞時，AI 模型將難以區分真實資訊和隱藏提示。")}}而當 AI 無法有效識別和過濾這些人為注入的提示詞，它就無法提供客觀公正的服務。這對於模型來說是個巨大的挑戰，要它基於內容回答問題，卻又要它不信任這些內容，它將陷入精神分裂狀態。🤯
