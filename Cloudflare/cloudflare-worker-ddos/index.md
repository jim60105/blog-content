...
需要注意的是我是免費 plan，**在超過流量時會被中斷服務而非被計價，所以我才沒有金錢損失**。服務中斷對我的 side project 來說並不是什麼大問題，這符合我的預期。<span class="hide">實際上這支 Worker 並沒有被中斷服務，我也不明白為什麼? 但我的其它 Worker 卻被中斷了。</span>
