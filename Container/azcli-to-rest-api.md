...
description = "從 azure-cli 到 REST API：我的 Azure Blob Storage 上傳優化之旅"
...
[extra]
banner = "https://img.maki0419.com/blog/preview/azcli-to-rest-api.png"
+++
[![](https://img.maki0419.com/blog/preview/azcli-to-rest-api.png)](https://img.maki0419.com/blog/preview/azcli-to-rest-api.png)
...
設計上會啟動一個 docker container，掛載裝有下載完成影片的 volume，然後把檔案上傳至 blob storage。它是運行在 Azure Container Instance 掛載 Azure File Share。
...
最後我放棄使用 azure-cli，改為[呼叫 REST api](https://learn.microsoft.com/zh-tw/rest/api/storageservices/put-blob)。我的需求其實很單純，就只是上傳個檔案而已，並不需要這麼強(肥)大的工具。
...
iscn://likecoin-chain/3DGNu2HPD0tXzVjLqRmyoOBljyl707TKim\_yh4XU2S8