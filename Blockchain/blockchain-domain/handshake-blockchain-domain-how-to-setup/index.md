...
[![](handshake/setup/1.png)](handshake/setup/1.png)

* 點右上的「Settings」
* 點左側的「Pages」，在右方選擇「main」這個branch  
[![](handshake/setup/2.png)](handshake/setup/2.png)  
[![](handshake/setup/3.png)](handshake/setup/3.png)
* 「Save」後等約兩分鐘，等Github將你的網站部署上去  
Github提供的網址為:` https://<你的username>.github.io/sample-html/ `，而我們後面要把它對應到Handshake domain  
[![](handshake/setup/4.png)](handshake/setup/4.png)
...
配置新主機請參考此設定  
[點擊放大 ![](handshake/setup/5.png)](handshake/setup/5.png)
...
* 安裝BIND
  ...
  * 在服務成功啟動後，新增防火牆規則，開啟UDP 53、TCP 53、10000 port，配置到VPS上  
   [![](handshake/setup/6.png)](handshake/setup/6.png)
  * 瀏覧器打開VPS的10000 port，預設密碼為`root/password`  
   [![](handshake/setup/bind%20%281%29.png)](handshake/setup/bind%20%281%29.png)

## 設定Bob Wallet中的網域

* 由左側的Domain Manager選擇目標domain，Add Records  
[![](handshake/setup/9.png)](handshake/setup/9.png)
* 新增兩條記錄，NS記錄和GLUE4記錄  
注意勿遺漏在網域後面的那個點(.)  
| NS    | ns1.chenchun.                 |
|-------|-------------------------------|
...
[![](handshake/setup/10.png)](handshake/setup/10.png)

* 寫到鏈上要15分鐘，但更新入Handshake domain要6小時以上。總之等個半天再來做測試吧  
[![](handshake/setup/11.png)](handshake/setup/11.png)
...
[![](handshake/setup/12.png)](handshake/setup/12.png)
* 在「Blockchain DNS records」中的ns1填入VPS的IP，ns2刪除  
[![](handshake/setup/13.png)](handshake/setup/13.png)
* 寫到鏈上要15分鐘，但更新入Handshake domain要6小時以上。總之等個半天再來做測試吧
...
[![](handshake/setup/bind%20%282%29.png)](handshake/setup/bind%20%282%29.png)
* 填寫如圖，按Create  
...
[![](handshake/setup/bind%20%283%29.png)](handshake/setup/bind%20%283%29.png)
* 選擇「Address」，填寫如圖，按Create  
| Name    | ns.chenchun     |
|---------|-----------------|
| Address | 178.128.XXX.XXX |
[![](handshake/setup/bind%20%284%29.png)](handshake/setup/bind%20%284%29.png)  
[![](handshake/setup/bind%20%285%29.png)](handshake/setup/bind%20%285%29.png)
* 選擇「Name Alias」，填寫如圖，按Create  
| Name      | color                                           |
|-----------|-------------------------------------------------|
| Real Name | <你的username>.github.io. (注意最後面有一個點！) |
[![](handshake/setup/bind%20%286%29.png)](handshake/setup/bind%20%286%29.png)  
[![](handshake/setup/bind%20%287%29.png)](handshake/setup/bind%20%287%29.png)
* 最後，點右上角的「Apply configuration」！  
[![](handshake/setup/bind%20%288%29.png)](handshake/setup/bind%20%288%29.png)
* 在主機上確認能否解析`color.chenchun`至jim60105.github.io.  
[![](handshake/setup/bind%20%289%29.png)](handshake/setup/bind%20%289%29.png)
...
[![](handshake/setup/15.png)](handshake/setup/15.png)

不用理會下方的設定失敗，Github不能解析Handshake domains

[![](handshake/setup/16.png)](handshake/setup/16.png)

## 結語

[![](handshake/setup/17.png)](handshake/setup/17.png)
